...
# np.save("/Users/dmr/Desktop/Data_PRL/KA_model/figure/msd_50000", msd, allow_pickle = True);

plt.plot(x,msd)
plt.xlabel("t 100*(0.2*(m*sigma^2/epsilon)^(1/2))")
plt.ylabel("MSD")
# plt.savefig("/Users/dmr/Desktop/Data_PRL/KA_model/figure/msd_50000.png", dpi = 300);
plt.show()
