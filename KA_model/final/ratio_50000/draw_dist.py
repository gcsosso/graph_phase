...
for sim in range(total_simulation_number):
    file_name = "sim_" + str(int(sim)) + "/answer/dist_s_I_" + str(frame) + ".npy";
...
dist = dist - dist[0];
dist[0] = dist[1];
np.save("/Users/dmr/Desktop/Data_PRL/KA_model/final/results/dist_50000", dist, allow_pickle=True);
...
np.save("swap/sop.npy", dist, allow_pickle=True)
